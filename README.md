...
- **Rules** — architecture, claude-md, coding, continuous-delivery, cpp, definitions, modern-software-engineering, python, react, refactoring, refactoring-catalog, testing, typescript, ui, ux, writing
