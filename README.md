...
- **Skills** — `/phil:claude-md`, `/phil:clean-comments`, `/phil:create-plugin-feature`, `/phil:edd`, `/phil:eos`, `/phil:extract-method`, `/phil:refactor`, `/phil:review-code`, `/phil:ux-review`, `/phil:work`
