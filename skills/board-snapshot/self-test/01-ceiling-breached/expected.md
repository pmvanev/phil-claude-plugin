...
It is sized so the two sections that may **not** be clipped already exceed the budget, which forces the
harder question: the clip comes entirely out of the queued section, or the run reports honestly that it
cannot fit. **The first sizing of this fixture was wrong** — 3 blocked and 4 in flight could not breach
