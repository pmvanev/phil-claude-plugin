...
Feature: Carry work across the session boundary without a re-briefing
  ...
  @walking_skeleton @driving_port @real-io @slice-01 @fixture(01-capture-and-resume)
  ...
  @slice-01 @error @fixture(02-no-op-session)
  ...
  @slice-01 @error @fixture(03-refuse-derivable)
  ...
  @slice-01 @error @real-io @fixture(04-stale-refuses-to-resume)
  ...
  @slice-01 @error @fixture(05-no-resume-point)
  ...
  @slice-02 @driving_port @fixture(06-route-to-owner)
  ...
  @slice-02 @error @fixture(07-live-wins-over-recorded)
  ...
  @slice-02 @error @fixture(08-unknown-owner-asks)
  ...
  @slice-03 @fixture(09-claim-and-basis)
  ...
  @slice-03 @error @fixture(10-competing-claim)
