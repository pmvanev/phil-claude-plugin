...
green to run AND exposes a real in-memory repository so a behavioural rewrite can assert on
observable persisted state instead of on mock interactions. Dependency-free on purpose.
"""
